...
def next_birthday(request, birthday):
    ...
    try:
        ...
        birthday = datetime.strptime(birthday, birthday_string)
    except ValueError:
        return HttpResponseBadRequest()
    ...
    upcoming_birthday_delta = upcoming_birthday - today
    return HttpResponse('Days until next birthday : {}'.format(upcoming_birthday_delta.days + 1))
...
def profile(request):
    ...
    '''
    context = {
        'name' : 'Ashutosh Ahmad Alexandar',
        'age' : 25
    }
    '''
    return render(request, 'profile.html', {
        'my_name' : 'Ashutosh Ahmad Alexandar',
        'my_age'  : 25
    })
